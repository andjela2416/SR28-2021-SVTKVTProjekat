...
public class UserDTO {
	...
	public UserDTO(User user) {
		this(user.getId(),user.getUsername(),user.getPassword(),user.getEmail(),user.getLastLogin(), 
				user.getFirstName(), user.getLastName(),user.getDisplayName(),user.getDescription(),user.getGroups(),user.getProfilePhoto());
	}
...
//	}
	...
	public UserDTO(Integer id, String username, String password, String email, LocalDateTime lastLogin,
			String firstName, String lastName, String displayName, String description,Set <Group> groups,String profilePhoto) {
		super();
		this.id = id;
